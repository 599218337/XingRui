const PERSON_AREA_POLYGON = [
  [111.40969717780142, 30.55605165460953],
  [111.40878768268571, 30.555080943489358],
  [111.40813371823843, 30.55447915080246],
  [111.40858706490374, 30.554184184564775],
  [111.40833211711757, 30.55388155551602],
  [111.40918676884482, 30.553317223788635],
  [111.41088738882421, 30.555270582287395],
  [111.40969717780142, 30.55605165460953]
];
    ...
    try {
      ...
      const filteredMap = rawData.reduce((pre, cur) => {
        ...
        if (isPointInPolygon(lon, lat, PERSON_AREA_POLYGON)) {
          ...
          const dept = cur.department || '相关方人员';
          if (!pre.has(dept)) {
            pre.set(dept, [cur]);
          } else {
